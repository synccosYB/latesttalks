...
export async function sendTicketEmails(ticket: {orderNumber:string;ticketCode:string;ticketNumber:number;buyerName:string;buyerEmail:string;buyerPhone?:string|null;quantity:number;amountCents:number;solaReferenceNumber:string}) {
